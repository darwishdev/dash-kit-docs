<template>
    <DocComponent title="Dialog Delete Restore" header="DialogDeleteRestore"
        description="The Dialog Delete Restore composable file is a powerful tool designed to streamline the process of confirming deletion 
